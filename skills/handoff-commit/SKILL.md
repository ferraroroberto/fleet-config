---
name: handoff-commit
description: Generate a copy-paste prompt handing off a GitHub commit to another LLM, instructing it to apply the same change to a sister project. Use on a public repo when the same change should be replicated in a private fork or vice versa, without copy-pasting code. Defaults to HEAD; accepts a commit-ish argument (SHA, HEAD~N, branch).
---
