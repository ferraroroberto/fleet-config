---
name: issue-finish
description: Finish a GitHub issue cleanly — confirm acceptance, update docs/README, run the verification gate, push, open a PR that closes the issue, handle CI as advisory (skip on no e2e surface; rerun a flake once), auto-merge, delete the branch, and restart the tray. Use when an issue branch is complete, e.g. "/issue-finish". Pairs with /issue-start.
---
