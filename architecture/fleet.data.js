...
window.FLEET = {
  ...
  "enabling": [
    {"ic": "🚀", "nm": "app-launcher", "port": ":8445", "ds": "<b>Where I live</b> — the central hub. Coding · Apps · Jobs · Life OS · Board (fleet kanban), all from the phone. Born from one goal: do <i>everything</i> on the PC from mobile. The entry point to it all."},
  ...
  "web": [
    ...
    {"ic": "🌡️", "nm": "home-automation", "port": 8447, "ds": "Home automation suite: AC, solar, alarm, network health, and native Home Assistant entities.", "chips": ["FastAPI", "PWA", "MELCloud", "SMA", "Tuya", "HA", "Telegram"]}
  ],
  "pipe": [
