// fleet.data.js — THE single source of truth for the system map.
// Loaded as plain JS (works under file://, no CORS): sets window.FLEET.
// The body is strict JSON so Python (the /system-map skill + the drift test in
// tests/run_acceptance.py) can read it too: strip "window.FLEET =" + trailing ";".
...
window.FLEET = {
  ...
  "enabling": [
    ...
    {"ic": "🧠", "nm": "local-llm-hub", "port": ":8000", "ds": "Shared LLM gateway — routes to local models or claude -p.", "chips": ["claude -p", "qwen :8081", "glm :8082", "gemma-e4b :8086", "gemma-26b :8087"]},
