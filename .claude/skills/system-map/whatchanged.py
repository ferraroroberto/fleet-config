...
invokes::
    ...
    E:/automation/fleet-config/.venv/Scripts/python.exe .claude/skills/system-map/whatchanged.py            # vs HEAD, default file
    E:/automation/fleet-config/.venv/Scripts/python.exe .claude/skills/system-map/whatchanged.py --ref main # vs another ref
