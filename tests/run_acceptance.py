...
from acceptance.checks_guards import (  # noqa: E402
    ...
    _venv_primary_guard_unit_checks,
...
def main() -> int:
    ...
    run_unit(_venv_primary_guard_unit_checks)
    run_unit(_venv_git_clean_guard_unit_checks)
    run_unit(_venv_cd_prefix_guard_unit_checks)
