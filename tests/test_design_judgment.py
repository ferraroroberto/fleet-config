...
check(rubric.version == "1.6.0", "rubric at 1.6.0 (the [[judgment]] checklist arrived in 1.2.0)")
...
check(p2b.returncode == 0 and "RUBRIC_MISMATCH=evaluate:0.9.0 judgment:1.6.0" in p2b.stdout and _kv(p2b).get("JUDGMENT") == "ok",
