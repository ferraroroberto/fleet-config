...
check(rubric.version == "1.5.1", "rubric at 1.5.1 (the [[judgment]] checklist arrived in 1.2.0)")
...
check(p2b.returncode == 0 and "RUBRIC_MISMATCH=evaluate:0.9.0 judgment:1.5.1" in p2b.stdout and _kv(p2b).get("JUDGMENT") == "ok",
